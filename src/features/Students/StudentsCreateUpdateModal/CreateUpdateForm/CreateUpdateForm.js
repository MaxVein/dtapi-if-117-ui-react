...
const CreateUpdateForm = ({
  ...
  const validationSchema = Yup.object().shape({
    lastname: Yup.string().required(
      "Поле не заповнене! Будь-ласка введіть прізвище студента"
    ),
    ...
    username: Yup.string()
      ...
      .max(
        12,
        "Довжина ім'я користувача не повинна бути більша ніж 12 символів"
      ),
    email: Yup.string()
      .matches(
    ...
    password: Yup.string()
      ...
      .required(
        "Поле не заповнене! Будь-ласка введіть унікальний пароль студента"
      )
  ...
  const [image, setImage] = useState(
    isUpdate && updateData ? updateData.photo : ""
  );
        ...
        <FormControl className={classes.FormControl}>
          <TextField
            ...
            error={
              ...
              Boolean(form.errors.password_confirm)
            }
            helperText={
